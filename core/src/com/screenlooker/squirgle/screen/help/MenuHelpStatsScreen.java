...
public class MenuHelpStatsScreen implements Screen, InputProcessor {
    ...
    public MenuHelpStatsScreen(final Squirgle game, Color veilColor) {
        this.game = game;
        ...
        generalButton = new Button((2 * game.partitionSize) + inputWidth,
                (6 * game.partitionSize) + (5 * inputHeightType),
                inputWidth,
                inputHeightType,
                Button.BUTTON_HELP_STATS_GENERAL,
                generalColor,
                Color.BLACK,
                game);
        squirgleButton = new Button((2 * game.partitionSize) + inputWidth,
                ...
                inputWidth,
                inputHeightType,
                Button.BUTTON_HELP_STATS_SQUIRGLE,
                squirgleColor,
                Color.BLACK,
                game);
        battleButton = new Button((2 * game.partitionSize) + inputWidth,
                ...
                inputWidth,
                inputHeightType,
                Button.BUTTON_HELP_STATS_BATTLE,
                battleColor,
                Color.BLACK,
                game);
        timeAttackButton = new Button((2 * game.partitionSize) + inputWidth,
                ...
                inputWidth,
                inputHeightType,
                Button.BUTTON_HELP_STATS_TIME_ATTACK,
                timeAttackColor,
                Color.BLACK,
                game);
        timeBattleButton = new Button((2 * game.partitionSize) + inputWidth,
                ...
                inputWidth,
                inputHeightType,
                Button.BUTTON_HELP_STATS_TIME_BATTLE,
                timeBattleColor,
                Color.BLACK,
                game);
        tranceButton = new Button((2 * game.partitionSize) + inputWidth,
                ...
                inputWidth,
                inputHeightType,
                Button.BUTTON_HELP_STATS_TRANCE,
                tranceColor,
                Color.BLACK,
                game);
        backButton = new Button(game.camera.viewportWidth - game.partitionSize - inputWidth,
                ...
                inputWidth,
                inputHeightBack,
                Button.BUTTON_HELP_STATS_BACK,
                backColor,
                Color.BLACK,
                game);

        buttonList = new ArrayList<Button>();
        buttonList.add(generalButton);
