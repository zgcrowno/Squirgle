...
public class MenuHelpTutorialTimeBattleScreen implements Screen, InputProcessor {
    ...
    public MenuHelpTutorialTimeBattleScreen(final Squirgle game, Color veilColor) {
        this.game = game;
        ...
        backButton = new Button(game.camera.viewportWidth - game.partitionSize - inputWidth,
                ...
                inputWidth,
                inputHeightBack,
                Button.BUTTON_HELP_TUTORIAL_TIME_BATTLE_BACK,
                backColor,
                Color.BLACK,
                game);
        ...
        for(int i = 0; i <= game.maxBase - game.minBase; i++) {
            ...
            int buttonType = Button.BUTTON_HELP_TUTORIAL_TIME_BATTLE_SQUARE + i;
