...
public class TimeBattleBaseSelectMultiplayerLocalScreen implements Screen, InputProcessor {
    ...
    public TimeBattleBaseSelectMultiplayerLocalScreen(final Squirgle game) {
        this.game = game;
