...
public class MenuTypeSinglePlayerTimeAttackScreen implements Screen, InputProcessor {
    ...
    public MenuTypeSinglePlayerTimeAttackScreen(final Squirgle game, Color veilColor) {
        this.game = game;
        ...
        backButton = new Button(game.camera.viewportWidth - game.partitionSize - inputWidth,
                ...
                inputWidth,
                inputHeightBack,
                Button.BUTTON_TYPE_SINGLE_PLAYER_TIME_ATTACK_BACK,
                backColor,
                Color.BLACK,
                game);
        ...
        for(int i = 0; i <= game.maxBase - game.minBase; i++) {
            ...
            int buttonType = Button.BUTTON_TYPE_SINGLE_PLAYER_TIME_ATTACK_SQUARE + i;
