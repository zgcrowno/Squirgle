...
public class MenuTypeMultiplayerLocalTimeBattleScreen implements Screen, InputProcessor {
    ...
    public MenuTypeMultiplayerLocalTimeBattleScreen(final Squirgle game, Color veilColor) {
        this.game = game;
        ...
        backButton = new Button(game.camera.viewportWidth - game.partitionSize - inputWidth,
                ...
                inputWidth,
                inputHeightBack,
                Button.BUTTON_TYPE_MULTIPLAYER_LOCAL_TIME_BATTLE_BACK,
                backColor,
                Color.BLACK,
                game);
        ...
        for(int i = 0; i <= game.maxBase - game.minBase; i++) {
            ...
            float y = ((3 * game.partitionSize) + (2 * inputHeightBase)) + (i * (game.partitionSize + inputHeightBase));
            int buttonType = Button.BUTTON_TYPE_MULTIPLAYER_LOCAL_TIME_BATTLE_SQUARE + i;
